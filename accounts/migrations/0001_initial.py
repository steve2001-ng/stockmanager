    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_administrator', models.BooleanField(default=False, verbose_name='Administrateur')),
                ...
                ('status', models.CharField(choices=[('SERVICE', 'En service'), ('CONGE', 'En congé'), ('MISSION', 'En mission')], default='SERVICE', max_length=10, verbose_name='Statut')),
